...
type nn struct {
	g                                  *ExprGraph
	w0, w1, w2, w3, w4, w5, w6, w7, w8, w9 *Node
...
func newNN(g *ExprGraph) *nn {
	...
	wB9 := tensor.Random(tensor.Float64, 3)
	...
	wT9 := tensor.New(tensor.WithBacking(wB9), tensor.WithShape(1, 3))
...
func (m *nn) fwd(x *Node) (err error) {
	var l0, l1, l2, l3, l4, l5, l6, l7, l8, l9 *Node
	...
	l8 = Must(Sigmoid(l8dot))
	l8dot := Must(Mul(l8, m.w8))
	l9 = Must(Sigmoid(l9dot))
	l9dot := Must(Mul(l9, m.w9))
