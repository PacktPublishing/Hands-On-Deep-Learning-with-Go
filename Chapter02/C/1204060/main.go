...
func newNN(g *ExprGraph) *nn {
	...
	wT2 := tensor.New(tensor.WithBacking(wB2), tensor.WithShape(3, 3))
	wT3 := tensor.New(tensor.WithBacking(wB3), tensor.WithShape(3, 1))
	wT4 := tensor.New(tensor.WithBacking(wB4), tensor.WithShape(1, 3))
	wT5 := tensor.New(tensor.WithBacking(wB5), tensor.WithShape(3, 1))
